interface OrderBulkEditModalProps {
    isOpen: boolean;
    onClose: () => void;
    bulkEditDate: string;
    setBulkEditDate: (date: string) => void;
    onSubmit: () => void;
    loading: boolean;
  }
  
  const OrderBulkEditModal: React.FC<OrderBulkEditModalProps> = ({
    isOpen,
    onClose,
    bulkEditDate,
    setBulkEditDate,
    ...
    return (
      <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center">
        <div className="bg-gray-800 p-6 rounded-lg w-full max-w-md text-white">
          <h2 className="text-xl font-bold mb-4">Bulk Edit Date</h2>
          <div className="mb-4">
  ...
  export default OrderBulkEditModal;